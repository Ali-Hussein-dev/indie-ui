...
import { Input, InputBlock } from '@/components/inputs/inputs';
...
<Tabs items={['Preview']}>
  <Tab value="Preview">
    <div className="py-4 mx-auto max-w-xl space-y-3">
      <InputBlock placeholder="Input Small" root={{ size: 'sm' }} />
      <InputBlock placeholder="Input default" />
      <InputBlock placeholder="Input Large" root={{ size: 'lg' }} />
      <br />
      <InputBlock
      ...
      />
      <InputBlock
        placeholder="Input with right & left icons"
        leftIcon={<IoSearchSharp className="text-zinc-500" />}
...
<Tabs items={['Preview']}>
  <Tab value="Preview">
    <div className="py-4 mx-auto max-w-xl space-y-3">
      ...
      />
      <InputBlock placeholder="Input default" root={{ variant: 'filled' }} />
      <InputBlock
        placeholder="Input Large"

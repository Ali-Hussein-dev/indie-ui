...
The header component comes with two variants (wide and centric) that are very common in web applications. You can also customize weather the header should be sticky or not easily.
...
<TypeTable
  type={{
    variant: {
      ...
      description:
        "The variant of the header component. The default variant is used for most pages, while the centric variant is used for pages with a centered layout.",
      default: "default",
    },
    sticky: {
      type: "boolean",
